        ...
        <div className="hidden lg:flex bg-blue-600 p-16 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-blue-100 text-lg font-medium leading-relaxed max-w-sm">
              Nền tảng quản lý nhân sự, chấm công và tính lương toàn diện cho
          ...
          <div className="relative z-10 flex items-center gap-4">
            <div className="flex -space-x-4">
              {[1, 2, 3, 4].map((n) => (
                <div
                  key={n}
                  className="w-10 h-10 rounded-full border-4 border-blue-600 bg-white/20 ring-2 ring-blue-600/20 flex items-center justify-center text-xs font-bold text-white"
                >
                  U{n}
                </div>
              ))}
        ...
        <div className="p-12 md:p-20 flex flex-col justify-center">
          ...
          >
            ...
            <div className="flex items-center gap-3 px-1">
              <input
                type="checkbox"
                id="remember"
                className="w-5 h-5 rounded-lg border-gray-200 text-blue-600 focus:ring-0 cursor-pointer"
              />
              <label
                htmlFor="remember"
            ...
            <button
              disabled={isPending}
              className="w-full py-5 bg-blue-600 text-white font-black rounded-4xl shadow-2xl shadow-blue-600/30 hover:bg-blue-700 hover:scale-[1.02] transition-all flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-12 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-3 py-4 bg-white border border-gray-100 rounded-2xl shadow-sm hover:bg-gray-50 transition-all font-bold text-sm text-gray-900"
              >
                <Chrome className="h-5 w-5 text-red-500" /> Google
              </button>
              <button
                type="button"
                className="flex items-center justify-center gap-3 py-4 bg-blue-600 rounded-2xl shadow-sm hover:bg-blue-700 transition-all font-bold text-sm text-white"
              >
