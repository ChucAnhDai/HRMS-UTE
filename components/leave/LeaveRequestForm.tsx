  ...
  return (
    <div id="leave-form-modal" className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 hidden backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-xl border border-gray-200 w-full max-w-2xl m-4 overflow-hidden relative animate-in fade-in zoom-in duration-200">
          <button 
            type="button"
            onClick={() => document.getElementById('leave-form-modal')?.classList.add('hidden')}
          ...
          <div className="p-6 border-b border-gray-100 bg-blue-50/30">
            ...
            <p className="text-sm text-gray-500 mt-1">Điền thông tin bên dưới để gửi yêu cầu lên quản lý xét duyệt.</p>
          </div>
          ...
          <div className="p-6 max-h-[80vh] overflow-y-auto">
            <form action={formAction}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <select 
                            ...
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-white text-gray-900"
                        >
                            <option value="Annual Leave">Nghỉ phép năm (Annual Leave)</option>
                    ...
                    <div className="space-y-2 md:col-span-2">
                        <label className="text-sm font-medium text-gray-700">Lý do nghỉ <span className="text-red-500">*</span></label>
                        <textarea 
                            name="reason" 
                            required
                            rows={3}
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    >
                        {isPending ? <Clock className="w-4 h-4 animate-spin" /> : <FileText className="w-4 h-4" />}
