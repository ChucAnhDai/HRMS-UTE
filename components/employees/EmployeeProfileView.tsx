...
import { Employee, Contract, Payslip, LeaveRequest, Asset } from "@/types";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
        <div className="h-32 bg-linear-to-r from-blue-600/10 to-blue-500/10"></div>
          ...
          <div className="relative flex flex-col md:flex-row items-end gap-6 -mt-12">
            ...
            <div className="flex-1 pb-2 space-y-1 text-center md:text-left">
              ...
              <p className="text-sm font-medium text-gray-500 flex items-center gap-2 justify-center md:justify-start">
                ...
                {employee.job_title || "Chưa có chức vụ"} -{" "}
                {employee.departments?.name || "Chưa phân phòng"}
              </p>
            </div>
            <div className="flex gap-3 pb-2 w-full md:w-auto justify-center items-center">
              {isManager && (
                <>
                  ...
                  <Link
                    ...
                    className="px-6 py-2 bg-blue-600 text-white text-sm font-bold rounded-lg shadow-sm hover:bg-blue-700 transition-colors flex items-center gap-2 h-fit"
                  >
              ...
              <a
                ...
                className="p-2 text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors h-fit bg-white"
              >
      ...
      <div className="min-h-[400px]">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      {
                        label: "Chức vụ",
                        value: employee.job_title || "Nhân viên",
                        icon: Briefcase,
                      },
                    ].map((item) => (
                      <div key={item.label} className="flex gap-4">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 overflow-hidden border border-gray-100">
                ...
                <div className="space-y-4">
                  {[
                    {
                      label: "Tổng phép năm",
                      value: `${employee.annual_leave_quota} ngày`,
                      color: "text-blue-600",
                    },
                    {
                      label: "Đã sử dụng",
                    ...
                    <div
                      key={item.label}
                      className="p-4 bg-gray-50 rounded-2xl space-y-1"
                    >
        ...
        {activeTab === "payroll" && (
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <PayrollTable payslips={payrolls} />
          </div>
        )}
