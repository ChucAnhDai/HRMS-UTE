...
export default function EmployeeDetailSidebar({
  ...
  const [contractIdToOperate, setContractIdToOperate] = useState<number | null>(null)
  const [assetIdToOperate, setAssetIdToOperate] = useState<number | null>(null)
  ...
  return (
    <>
      ...
      <ConfirmDialog
        isOpen={isContractConfirmOpen}
        onOpenChange={setIsContractConfirmOpen}
      ...
      <ConfirmDialog
        isOpen={isAssetConfirmOpen}
        onOpenChange={setIsAssetConfirmOpen}
        title="Xác nhận thu hồi tài sản"
        description="Bạn có chắc chắn muốn thu hồi tài sản này từ nhân viên?"
