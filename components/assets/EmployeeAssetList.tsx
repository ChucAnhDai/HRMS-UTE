...
export default function EmployeeAssetList({ assets, employeeId }: EmployeeAssetListProps) {
  ...
  if (!assets || assets.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">Nhân viên chưa được cấp phát tài sản nào</p>
      </div>
    )
  }
