          ...
          <div className="mt-4">
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-400 ml-4">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 py-3 rounded-full border border-gray-300 hover:bg-white transition-colors text-sm font-medium text-gray-700"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
          ...
          <div className="absolute inset-0 z-10 p-12 flex flex-col justify-between">
              ...
              <div className="bg-gray-800/80 backdrop-blur-md text-white p-4 rounded-2xl shadow-xl max-w-xs border border-white/10">
                ...
                <div className="flex -space-x-2 mt-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-6 h-6 rounded-full border border-gray-700 bg-gray-600"
                    ></div>
                  ))}
                </div>
              </div>
            ...
            <div className="absolute top-1/2 right-12 transform -translate-y-1/2">
              <div className="relative w-32 h-32">
                <div className="absolute top-0 right-0 w-12 h-12 rounded-full border-2 border-white overflow-hidden shadow-lg">
                  <Image
                ...
                <div className="absolute bottom-2 right-8 w-14 h-14 rounded-full border-2 border-white overflow-hidden shadow-lg z-10">
                  <Image
                ...
                <div className="absolute top-8 left-0 w-10 h-10 rounded-full border-2 border-white overflow-hidden shadow-lg">
                  <Image
            ...
            <div className="mt-auto mb-12 flex items-end gap-4 overflow-x-auto no-scrollbar">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 text-white min-w-[300px]">
                <div className="flex justify-between text-center gap-4 text-sm">
                  ...
                  <div className="opacity-100 font-bold bg-white/20 rounded-lg py-1 px-2">
                    Tue
                    <br />
              ...
              <div className="bg-white rounded-2xl p-4 shadow-2xl min-w-[200px] transform translate-y-8">
                ...
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-6 h-6 rounded-full border border-white bg-gray-300 overflow-hidden relative"
                    >
                      <Image
                        src={`https://i.pravatar.cc/150?u=${i}00`}
                        alt={`Meeting participant ${i}`}
                        fill
                        className="object-cover"
                        sizes="24px"
                      />
